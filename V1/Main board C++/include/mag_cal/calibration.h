...
public:
  ...
  Angles getAngles(const Eigen::Vector3f &mag,
  ...
  static Eigen::Matrix3f anglesToMatrix(float azimuth, float inclination,
                                        float roll);
  ...
  AnomalyType checkAnomaly(const Eigen::Vector3f &mag,
  ...
  fitEllipsoid(const std::vector<Eigen::Vector3f> &magData,
  ...
  std::pair<float, float>
  uniformity(const std::vector<Eigen::Vector3f> &magData,
  ...
  findSimilarShots(const std::vector<Eigen::Vector3f> &magData,
                   const std::vector<Eigen::Vector3f> &gravData,
  ...
  bool isCalibrated() const {
    return mag_.isCalibrated() && grav_.isCalibrated();
  }
...
private:
  ...
  static bool isARun(const std::vector<float> &azimuths,
                     const std::vector<float> &inclinations, float precision);
  ...
  std::vector<float>
  getLstsqNonLinearParams(int paramCount,
