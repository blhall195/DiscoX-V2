...
bool LaserEgismos::parseFrame(const uint8_t *buf, size_t len, uint8_t &command,
                              uint8_t &address, const uint8_t *&dataStart,
                              size_t &dataLen) {
  if (len < 5) {
...
LaserError LaserEgismos::checkMeasurementResult(const uint8_t *data, size_t len,
                                                int32_t &distanceMm) {
