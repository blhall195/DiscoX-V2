...
const uint8_t SAP6_SERVICE_UUID[16] = {0x65, 0xC9, 0xBD, 0xC6, 0x92, 0x37,
                                       0xF1, 0x93, 0xCB, 0x4B, 0x64, 0x8A,
                                       0x35, 0x44, 0x7C, 0x13};
const uint8_t SAP6_PROTO_NAME_UUID[16] = {0x66, 0xC9, 0xBD, 0xC6, 0x92, 0x37,
                                          0xF1, 0x93, 0xCB, 0x4B, 0x64, 0x8A,
                                          0x35, 0x44, 0x7C, 0x13};
const uint8_t SAP6_COMMAND_UUID[16] = {0x67, 0xC9, 0xBD, 0xC6, 0x92, 0x37,
                                       0xF1, 0x93, 0xCB, 0x4B, 0x64, 0x8A,
                                       0x35, 0x44, 0x7C, 0x13};
const uint8_t SAP6_LEG_DATA_UUID[16] = {0x68, 0xC9, 0xBD, 0xC6, 0x92, 0x37,
                                        0xF1, 0x93, 0xCB, 0x4B, 0x64, 0x8A,
                                        0x35, 0x44, 0x7C, 0x13};
...
void SAP6Protocol::sendData(float azimuth, float inclination, float distance,
                            float roll) {
...
void SAP6Protocol::onCommandWrite(uint16_t /*conn_hdl*/, uint8_t *data,
                                  uint16_t /*len*/) {
  _pendingCmd = data[0];
  _cmdReceived = true;
}
